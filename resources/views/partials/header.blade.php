<nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
    <div class="container">
        <a class="navbar-brand d-flex align-items-center" href="{{ url('/') }}">
            <div class="logo_laravel bg-primary rounded-circle">
                <img src="{{asset('storage/cover/logo-deliveboo.png')}}" alt="" style="width:100px">
            </div>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav me-auto">
                <li class="nav-item d-md-flex  d-sm-flex-column">
                    ...
                    <a class="nav-link {{ Route::currentRouteName() == 'admin.dishes.create' ? 'active' : '' }}" href="{{ route('admin.dishes.create') }}">Crea piatto</a>
